...
function MatchedKeywords({ matchedKeywords = localStorage.getItem("analysisResults")?JSON.parse(localStorage.getItem("analysisResults")).matchedKeywordsInResume:["Loading..."]}) {
